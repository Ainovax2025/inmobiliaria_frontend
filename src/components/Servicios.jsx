...
const Servicios = () => {
  ...
  const servicios = [
    {
      titulo: "Asesorías",
      descripcion: "Brindamos asesoría jurídica y contable (declaración de renta) en la compra o venta de una propiedad.",
      icono: <FaBalanceScale />,
    },
    {
      titulo: "Venta",
      descripcion: "Realizamos avalúos, fotografía profesional, video publicitario y gestionamos todo el proceso de venta.",
      icono: <FaHome />,
    },
    {
      titulo: "Compra",
  ...
  return (
    <div className="servicios-container">
      ...
      <p className="servicios-subtitle">Haz clic en un servicio para ver más detalles.</p>

      <div className="servicios-list">
        {servicios.map((servicio, index) => (
          <div
            key={index}
            className={`servicio-item ${activeIndex === index ? "active" : ""}`}
